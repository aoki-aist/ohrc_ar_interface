...
{
    [Serializable]
    public class BodyPartStateMsg : Message
    {
        public const string k_RosMessageName = "ohrc_msgs/BodyPartState";
        ...
        public BodyPartStateMsg(Geometry.PoseMsg pose, Geometry.TwistMsg twist, float[] stick, bool[] button, bool[] touch, double squeeze, double trigger, double grip)
        {
            this.pose = pose;
            this.twist = twist;
            this.stick = stick;
        ...
        public static BodyPartStateMsg Deserialize(MessageDeserializer deserializer) => new BodyPartStateMsg(deserializer);

        private BodyPartStateMsg(MessageDeserializer deserializer)
        {
